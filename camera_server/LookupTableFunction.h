...
public:
	...
	bool generate_pointcloud_depth(cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1, cv::Mat xL_rotate_y1, cv::Mat rectify_R11, cv::Mat pattern_mapping1,float b);
	bool generate_pointcloud_depth_repetition(cv::Mat mask, cv::Mat unwrap, cv::Mat& depth, cv::Mat& point, cv::Mat xL_rotate_x1, cv::Mat xL_rotate_y1, cv::Mat rectify_R11, cv::Mat pattern_mapping1, float b);
	...
	bool readBinMappingFloat1(int rows, int cols, std::string mapping_file, cv::Mat& out_map);
